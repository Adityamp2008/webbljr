<template>
  <div class="min-h-screen flex flex-col bg-[#282A35]">

    <!-- Header -->
    <header class="bg-white text-[#0d6efd] px-3 shadow-md flex">
      <h1 class="text-3xl font-semibold">wss</h1>
   
      <nav class="flex items-stretch justify- h-14 px-6">
        
        <div class="relative flex group">
          
          <button class="h-full px-4 flex items-center gap-2 font-semibold tracking-tight bg-white text-[#282A35] transition-all duration-200 
                         group-hover:bg-[#0D6EFD] group-hover:text-white">
            Tutorials
          ...
          <div class="absolute top-full left-0 w-48 bg-white shadow-xl border-t border-gray-100 z-50 py-2
                      invisible opacity-0 translate-y-2 group-hover:visible group-hover:opacity-100 group-hover:translate-y-0 
                      transition-all duration-300">
            <a href="#" class="block px-6 py-2 text-sm text-gray-700 hover:bg-[#E7F1FF] hover:text-[#0D6EFD]">HTML</a>
            <a href="#" class="block px-6 py-2 text-sm text-gray-700 hover:bg-[#E7F1FF] hover:text-[#0D6EFD]">CSS</a>
            <a href="#" class="block px-6 py-2 text-sm text-gray-700 hover:bg-[#E7F1FF] hover:text-[#0D6EFD]">PHP</a>
            <div class="my-1 border-t border-gray-100"></div>
            <a href="#" class="block px-6 py-2 text-sm font-bold text-[#0D6EFD]">All Courses</a>
          </div>
        </div>
      ...
      <div class="flex items-center space-x-2">
        <div class="relative w-64">
          <input 
            type="text" 
            placeholder="Search..." 
            class="w-full py-2 pl-4 pr-10 text-sm italic text-blue-900 border border-gray-300 rounded-full focus:outline-none focus:ring-1 focus:ring-gray-400 bg-white"
          >
    ...
    <nav class="bg-[#282A35] h-8 flex items-stretch">
        <router-link 
            v-for="materi in ['html', 'javascript', 'css', 'php', 'python', 'sql']" 
            :key="materi"
            :to="'/belajar/' + materi" 
            class="flex items-center px-6 text-white text-sm uppercase tracking-wide transition-colors duration-200 hover:bg-[#1A1C23]"
            active-class="bg-[#04AA6D]" 
          >
            {{ materi }}
          </router-link>
    </nav>
    
    <div class="space-y-8 p-6 bg-[#282A35] w-full mt-12">
        <section class="bg-[#282A35] rounded-sm p-6 ">
                <h2 class="text-5xl font-bold text-white text-center">
                  Selagi masih berakal tiap detik adalah belajar
                </h2>
    
        </section>
    </div>
    
    <div class="space-y-8 p-6 bg-[#BBDCE5] w-full mt-12  ">
        <section class="bg-[#BBDCE5] rounded-sm p-6 ">
            <div class="flex justify-center">
                <div class=" flex-1">
                    <h3 class="text-5xl font-bold text-black text-center px-6">
                        parhan</h3>
                </div>
                <div class="flex-1">
                  <div class="max-w-sm rounded overflow-hidden shadow-lg bg-white">
                    <div class="px-6 py-4">
                      <div class="font-bold text-xl mb-2">example</div>
                      
                      <p class="text-white text-base shadow-xl border-l-4 border-emerald-500 p-4 bg-[#1A1C23]">
                      
                        <code>
                        def cek_status(sukses):
                            if sukses:
                                print("Alhamdulillah")
                            else:
                                print("Terus berusaha")
